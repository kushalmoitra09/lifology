...
import { SchemeAppointmentDetails } from '../../../../helpers/GraphQLSchemes'

export default function SessionDetails({ profile }) {
...
export async function getServerSideProps(context) {
    ...
    const appointmentDetails = await queryGraph(skillClient, { id: context.params.id }, SchemeAppointmentDetails)
        .then((res) => {
